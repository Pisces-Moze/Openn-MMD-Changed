...
public class InventoryRenderHelper {
    ...
    private static Quaternionf calculateRotation(AbstractClientPlayer player) {
        ...
        // Vanilla temporarily turns the inventory entity by roughly 180 degrees.
        // MMD models use the opposite forward axis, so compensate that base turn
        // while preserving the mouse-driven part of the rotation.
        Quaternionf yaw = new Quaternionf().rotateY(
                (float)Math.PI - player.yBodyRot * ((float)Math.PI / 180F));
