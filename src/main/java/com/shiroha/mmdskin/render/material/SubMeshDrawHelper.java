...
public final class SubMeshDrawHelper {
    ...
    public interface MaterialFilter {
        boolean shouldDraw(int materialId);
    }

    @FunctionalInterface
    public interface MaterialState {
        void apply(int materialId);
    }
    ...
    public static void draw(ByteBuffer subMeshDataBuf,
        ...
        draw(subMeshDataBuf, subMeshCount, indexElementSize, indexType, textureResolver,
                alphaResolver, materialId -> true, materialId -> { });
    }
