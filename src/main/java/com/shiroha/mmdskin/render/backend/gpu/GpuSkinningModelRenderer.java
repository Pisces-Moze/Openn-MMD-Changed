...
final class GpuSkinningModelRenderer {
    ...
    private static void renderOutlinePass(GpuSkinningModelInstance target, Minecraft minecraft) {
        ...
        SubMeshDrawHelper.drawOutline(
                ...
                materialId -> ToonRenderHelper.setupOutlineMaterial(
                        GpuSkinningModelInstance.toonShaderCpu, target.mats[materialId])
        );
    ...
    private static void drawStandardSubMeshes(GpuSkinningModelInstance target, Minecraft minecraft,
